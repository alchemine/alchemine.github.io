...
![alt text](/_posts/DataEngineering/Kubernetes/image-1.png)
- 개요
    - 클러스터 관리
    - 상태 관리 및 명령어 처리
    - 1~n개 (홀수)
...
### Node (Worker Node)
![alt text](/_posts/DataEngineering/Kubernetes/image-2.png)
- 개요
    - 어플리케이션 컨테이너 실행
1. kubelet
...
# API 리소스
![alt text](/_posts/DataEngineering/Kubernetes/image-3.png)
## API 리소스와 오브젝트
1. API 리소스

...
![Alt text](/images/2023-09-08-gnn-3.png)[^1]

### 1.1.1 Node embedding
#### 1.1.1.1 Shallow embedding method
...
### 1.1.4 Aggregation
### 1.1.5 Neighborhood and adjacency matrix
### 1.1.6 (Neighborhood) Attention
